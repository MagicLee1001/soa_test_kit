...
def run_job():
    ...
    parser.add_argument('-s', '--server', type=str, help='上位机地址', default='')
    parser.add_argument('-t', '--task_id', type=str, help='任务ID', default='')
    parser.add_argument('-d', '--distribute_id', type=str, help='任务分发ID', default='')
    parser.add_argument('-p', '--path', type=str, help='远程svn用例地址', default='')
